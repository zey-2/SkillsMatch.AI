...
class SQLiteGPTAnalyzer:
    ...
    def __init__(self):
        ...
        if HAS_OPENAI:
            ...
            api_key = (
                ...
                or os.environ.get("GITHUB_TOKEN")  # For GitHub Models
            )

            if api_key and api_key.startswith("ghp_"):
                # GitHub Models
                self.client = OpenAI(
                    base_url="https://models.github.ai/inference", api_key=api_key
                )
    ...
    def get_database_summary(self) -> Dict[str, Any]:
        ...
        with sqlite3.connect(self.db_path) as conn:
            ...
            return {
                ...
                "tables": {
                    "jobs": {"count": jobs_count, "categories": job_categories},
                    "user_profiles": {
                        "count": profiles_count,
                        "experience_levels": experience_levels,
                    },
                    "skills": {"count": skills_count, "popular_skills": popular_skills},
                },
            }

    def get_specific_profile_data(
        self, user_name: str = "TIM COOKING"
    ) -> Optional[Dict]:
    ...
    def get_matching_jobs_data(
        self, user_skills: List[str], limit: int = 10
    ) -> List[Dict]:
    ...
    async def analyze_with_gpt4(
        self, data: Dict[str, Any], analysis_type: str = "job_matching"
    ) -> str:
    ...
    def demonstrate_analysis(self):
        ...
        print(
            f"✅ Found {db_summary['tables']['jobs']['count']} jobs, {db_summary['tables']['user_profiles']['count']} profiles"
        )
        ...
        if profile_data:
            ...
            print(
                f"📋 Skills: {[skill['skill_name'] for skill in profile_data['skills']]}"
            )
        ...
        print(
            f"📊 Popular skills: {db_summary['tables']['skills']['popular_skills'][:5]}"
        )
