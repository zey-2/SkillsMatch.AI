...
def switch_to_github_models() -> None:
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1 and sys.argv[1] == "restore":
        ...
        print("\n📋 Usage:")
        print(
            "  python scripts/use_github_models.py        "
            "# Switch to GitHub Models (free)"
        )
        print(
            "  python scripts/use_github_models.py restore "
            "# Restore OpenAI (when quota reset)"
        )